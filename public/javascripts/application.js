var overallChart = c3.generate({
    ...
    data: {
        ...
        columns: [
            ...
            ['AIs x1000', 30, 200, 100, 400, 150, 250],
            ['Conversions', 130, 340, 200, 500, 250, 350]
        ]
    },
    axis: {
        x: {
...
var yesterdayChart = c3.generate({
...
var budgetChart = c3.generate({
    ...
    data: {
        columns: [
            ['Remaining budget', 300, 270, 220, 160, 90, 50]
        ],
        type: 'spline'
    }
});
...
setTimeout(function () {
    overallChart.load({
        columns: [
            ['Clicks', 400, 500, 450, 700, 600, 500]
        ]
    });
